...
import FunFactArea from "./components/FunFactArea.vue";
import MainBannerArea from "./components/MainBannerArea.vue";
</script>

<template>

<div data-bs-spy="scroll" data-bs-offset="120">
...
<section id="about" class="about-area pb-100">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="about-image">
                    <img src="/src/assets/img/about.png" alt="image">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="default-shape">
        <div class="shape-1">
            <img src="/src/assets/img/shape/1.png" alt="image">
        </div>

        <div class="shape-2 rotateme">
            <img src="/src/assets/img/shape/2.png" alt="image">
        </div>

        <div class="shape-3">
            <img src="/src/assets/img/shape/3.svg" alt="image">
        </div>

        <div class="shape-4">
            <img src="/src/assets/img/shape/4.svg" alt="image">
        </div>

        <div class="shape-5">
            <img src="/src/assets/img/shape/5.png" alt="image">
        </div>
    </div>
</section>
<!-- End About Area -->
    ...
    <div class="container-fluid">
        ...
        <div class="screenshot-slider owl-carousel owl-theme">
            <div class="screenshot-item">
                <div class="image">
                    <img src="/src/assets/img/screenshot/1.png" alt="image">
                </div>
            </div>

            <div class="screenshot-item">
                <div class="image">
                    <img src="/src/assets/img/screenshot/2.png" alt="image">
                </div>
            </div>

            <div class="screenshot-item">
                <div class="image">
                    <img src="/src/assets/img/screenshot/3.png" alt="image">
                </div>
            </div>

            <div class="screenshot-item">
                <div class="image">
                    <img src="/src/assets/img/screenshot/4.png" alt="image">
                </div>
            </div>

            <div class="screenshot-item">
                <div class="image">
                    <img src="/src/assets/img/screenshot/5.png" alt="image">
                </div>
            </div>

            <div class="screenshot-item">
                <div class="image">
                    <img src="/src/assets/img/screenshot/6.png" alt="image">
                </div>
            </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="overview-image">
                    <img src="/src/assets/img/overview.png" alt="image">
                </div>
            </div>
        </div>
    </div>
...
<section id="faq" class="faq-area ptb-100">
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="faq-image">
                    <img src="/src/assets/img/faq-mobile.png" alt="image">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="single-team">
                    <div class="image">
                        <img src="/src/assets/img/team/image1.jpg" alt="image">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-team">
                    <div class="image">
                        <img src="/src/assets/img/team/image2.jpg" alt="image">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-team">
                    <div class="image">
                        <img src="/src/assets/img/team/image3.jpg" alt="image">
    ...
    <div class="container">
        <div class="app-download-content">
            ...
            <div class="app-holder">
                <a href="#">
                    <img src="/src/assets/img/store/1.png" alt="image">
                </a>
                <a href="#">
                    <img src="/src/assets/img/store/2.png" alt="image">
                </a>
            </div>
        </div>
    </div>
